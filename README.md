...
- **演示**：设计师在 01_产品库 录入新 SKU "DRS-0501-FL" → 自动算售罄率 + 退货率 + 可售天数；老板娘问 `找出售罄率低于 50% 的产品` → cockpit 拉表 → DEEPSEEK 分析"3 个 SKU 命中"
- **完整字段全景**（基于真实服装电商运营梳理）：

![产品库字段全景](./docs/images/product-library-fields.png)
